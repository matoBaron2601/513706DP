...
import type { BlockDto, ConceptDto, ConceptProgressDto, CreateBlockDto, CreateConceptProgressDto, UpdateBlockDto, UpdateConceptProgressDto } from '../db/schema';
...
export class ConceptProgressService {
    ...
    async update(id: string, data: UpdateConceptProgressDto, tx?: Transaction): Promise<ConceptProgressDto> {
    ...
    async createMany(data: CreateConceptProgressDto[], tx?: Transaction): Promise<ConceptProgressDto[]> {
