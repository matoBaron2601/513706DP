...
describe('ConceptRepository', () => {
	...
	it('getById: returns concept when it exists', async () => {
		...
		const repo = new ConceptRepository(makeFakeDbClient({ selectResult: [row] }).getDbClient);
	...
	it('getById: returns undefined when concept does not exist', async () => {
		const repo = new ConceptRepository(makeFakeDbClient({ selectResult: [] }).getDbClient);
	...
	it('getByIds: returns array of concepts', async () => {
		...
		const repo = new ConceptRepository(makeFakeDbClient({ selectResult: rows }).getDbClient);
	...
	it('create: returns inserted concept from returning()', async () => {
		...
		const repo = new ConceptRepository(makeFakeDbClient({ insertReturn: [returned] }).getDbClient);
	...
	it('update: returns updated concept from returning()', async () => {
		...
		const repo = new ConceptRepository(makeFakeDbClient({ updateReturn: [returned] }).getDbClient);
	...
	it('update: returns undefined when returning() is empty', async () => {
		...
		const repo = new ConceptRepository(makeFakeDbClient({ updateReturn: [] }).getDbClient);
	...
	it('delete: returns deleted concept from returning()', async () => {
		...
		const repo = new ConceptRepository(makeFakeDbClient({ deleteReturn: [deleted] }).getDbClient);
	...
	it('delete: returns undefined when nothing was deleted', async () => {
		const repo = new ConceptRepository(makeFakeDbClient({ deleteReturn: [] }).getDbClient);
