...
describe('PlacementQuizRepository', () => {
	...
	it('getById: returns placementQuiz when it exists', async () => {
		...
		const repo = new PlacementQuizRepository(makeFakeDbClient({ selectResult: [row] }).getDbClient);
	...
	it('getById: returns undefined when placementQuiz does not exist', async () => {
		const repo = new PlacementQuizRepository(makeFakeDbClient({ selectResult: [] }).getDbClient);
	...
	it('getByIds: returns array of rows', async () => {
		...
		const repo = new PlacementQuizRepository(makeFakeDbClient({ selectResult: rows }).getDbClient);
	...
	it('update: returns undefined when returning() is empty', async () => {
		...
		const repo = new PlacementQuizRepository(makeFakeDbClient({ updateReturn: [] }).getDbClient);
	...
	it('delete: returns undefined when nothing was deleted', async () => {
		const repo = new PlacementQuizRepository(makeFakeDbClient({ deleteReturn: [] }).getDbClient);
